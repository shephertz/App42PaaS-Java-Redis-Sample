Getting Started with App42PaaS-Java-Redis-Sample Application:
----------------------------------------------------

This application is basically a simple input form that takes input from user and saves it in database.

<b>[Download the source code from git.](https://github.com/shephertz/App42PaaS-Java-Redis-Sample/archive/master.zip)</b>
